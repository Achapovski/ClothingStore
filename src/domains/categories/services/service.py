...
class CategoryService:
    ...
    async def create_category(self, model: CategoryCreateModel) -> Optional[CategoryModel]:
        async with self._uow as uow:
            category = await uow.categories.add(model=model)
            return category

    async def get_category(self, id_: UUID) -> Optional[CategoryModel]:
        async with self._uow as uow:
    ...
    async def update_category(self, id_: UUID, model: CategoryModel) -> Optional[CategoryModel]:
        async with self._uow as uow:
