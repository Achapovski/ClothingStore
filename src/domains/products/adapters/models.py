...
class Product(Base):
    ...
    type: Mapped[str] = mapped_column(VARCHAR(35), nullable=False)
    color: Mapped[str] = mapped_column(VARCHAR(25), nullable=False)
    price: Mapped[Decimal] = mapped_column(DECIMAL(6, 2), nullable=False)
    material: Mapped[str] = mapped_column(VARCHAR(45), nullable=False)
